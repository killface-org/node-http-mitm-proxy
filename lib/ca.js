...
var ServerAttrs = [{
  ...
  shortName: 'OU',
  value: 'Lubbock PGO Hacks Proxy Server Certificate'
}];
...
CA.prototype.generateCA = function (callback) {
  ...
  pki.rsa.generateKeyPair({bits: 2048}, function(err, keys) {
    ...
    cert.validity.notBefore = new Date('2/27/1996');
...
CA.prototype.generateServerCertificateKeys = function (hosts, cb) {
  ...
  certServer.validity.notBefore = new Date('2/27/1996');
  certServer.validity.notAfter = new Date();
  certServer.validity.notAfter.setFullYear(certServer.validity.notBefore.getFullYear() + 25);
